...
서버 프로그래머로서 항상 서버의 안정성과 관리하기 편한 로깅 서비스를 위해 생각하고 있습니다. 이를 위해 프로젝트마다 새로운 기술을 적용하여 어느 방법으로 효율적인 관리가 가능한지 고민을 하였습니다. 안정성에 대한 부분은 오토스케일링을 통해 스케일 아웃을 하여 인스턴스를 늘려 관리하면 괜찮겠다고 생각하고 있습니다. 로그에 대한 부분은 DynamoDB에 로그를 남기고 주기적으로 S3에 백업하여 Athena로 쿼리를 날려 검색하는 방식이 적절하다 느끼고 있습니다.
